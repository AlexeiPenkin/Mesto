...
const addCardSubmitButton = document.querySelector(".popup.add-card .form__submit-button");
...
const createCard = (cardInfo) => {
  ...
  cardListItem.querySelector(".card__image").title = cardInfo.name;
  ...
  popupImageCloseButton.addEventListener("click", () => {popupImageOpen.classList.remove("popup_opened")
  });
...
function openProfileEditPopup(popupProfileEdit) { // openProfileEditPopup = openPopup
  popupProfileEdit.classList.add("popup_opened");
}

profileEditButton.addEventListener("click", () =>
  openProfileEditPopup(popupProfileEdit, popupProfileEditOpen) // openProfileEditPopup = openPopup
);
...
function submitProfileEditForm(evt) {
  ...
  closeProfileEditPopup(popupProfileEdit); // closeProfileEditPopup = closePopup
}
formProfileEdit.addEventListener("submit", submitProfileEditForm);

// закрытие формы ProfileEdit
function closeProfileEditPopup() { // closeProfileEditPopup = closePopup
